...
/// 图片上添加问题
- (UIImage *)drawStringForImage:(UIImage *)image andDescription:(NSString *)text{
    ...
    CGRect rect = CGRectMake(10, 10, image.size.width-5, image.size.height);
